...
//$query_RsStatusUrusan = "SELECT * FROM tblstatusurusan WHERE idUrusan='$idUrusan'";
  $query_RsStatusUrusan = "SELECT a.id,c.Gelaran,c.NamaPenuh,c.Login,c.Email,c.Jawatan,a.Susunan,d.Bahagian,e.desc_kategori,c.Status FROM `tbluruspengguna` a
...
where a.TajukMesyuaratID ='$idM'  and a.kategoriID in('1','2')  order by a.susunan,c.NamaPenuh asc";
           ...
           <tr class="info"  >
            ...
            <tr class="info"  >
              <td colspan="6"><div align="left" >
                <hr>
                <h4>
                  SENARAI PENGERUSI DAN AHLI YANG AKAN MENERIMA URUSAN </h4><hr>
              </div></td>
              </tr>
              ...
              <td colspan="6" valign="top"><div align="center" style="font-weight: bold">
                <table width="900" border="0" cellspacing="0" cellpadding="0" bgcolor="#666666">
                  <tr bgcolor="#999999">
                    ...
                    <td width="53%"><strong>Jawatan</strong></td>
                  </tr>
                  ...
                  <?php
                    ...
                    <tr bgcolor="#FFFFFF" class="style2">
                      <td valign="top"><?php echo $No; ?></td>
						 ...
						 <b><br />						                        </td>                   
                                       <td><?php echo strtoupper($row_RsStatusUrusan['desc_kategori']);?></td>
