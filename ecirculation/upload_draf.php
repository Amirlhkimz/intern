...
/////////////////REQUEST DATA START////////////////
		 ...
		 $vbilCir=mysql_real_escape_string($_POST['bilMesyK']);
		 $strJenisUrusan=$_POST['selectJenisUrusan'];
		 $strGredUrusan=$_POST['gredurusan'];
		 $strGredJawatan=$_POST['gredJawatan'];
         $strRingkasan=mysql_real_escape_string($_POST['txtRingkasan']);
		 $txtKeteranganRingkasan=mysql_real_escape_string($_POST['txtKeteranganRingkasan']);
    ...
    //echo "Temp file: " . $_FILES["file"]["tmp_name"] . "<br />";
		...
		//-------------------///////////////////SAVE in tblurusan & tblstatusurusan START////////////////////////////////////////////////////
								...
								$sqlurusan = "Insert into tblurusan
												(Jenis, Ringkasan, Kertas, NoKertas, rujBhg, bilMesyuarat, Link, idCipta, TrCipta, Status, idkemaskini,GredUrusan,gredJawatan,KeteranganRingkasan)
												values
												('$strJenisUrusan', '$strRingkasan', '$strKertas', '$strNoKertas', '$strNoRuj', '$vbilCir','$strLink', '$stridCipta', '$strTrCipta', '$strStatus', '$stridCipta','$strGredUrusan','$strGredJawatan','$txtKeteranganRingkasan')";
		                      	...
		                      	$result3 = mysql_query($sqlpengguna) or die(mysql_error());
									while ($row_result3 = mysql_fetch_assoc($result3))
											...
											if(!isset($_POST['submit']))
												...
												//Not Send the email! (hanya untuk draf)
