...
ini_set('sendmail_from','aduan@spa.gov.my');
...
$query_RsStatusUrusan = "select COUNT(*) from tblstatusurusan where idPengguna = '43'
						...
						AND TrBuka BETWEEN timestamp(now()-3000) AND timestamp(now()-6000); ";
...
$fp = fsockopen("postmaster.1govuc.gov.my", 25, $errno, $errstr, 30);
		...
		$subject = "Maklumat Aduan di Sistem ePertanyaan SPA";// Subject for the email
