...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="100%" align="center" valign="top"><h3><img src="images/logo_spa.png" width="92" height="64" /><br />
      Perincian Keputusan di eCirculation SPA
<!--<div>-->
</h3>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
           ...
           <tr class="info"  >
            ...
            <tr>
              ...
              <td valign="top"><div align="center" style="font-weight: bold">:</div></td>
              <td valign="top"><div align="left"><?php echo format_datetime($row_RsUrusan['TrCipta']); ?></div></td>
              <td valign="top"><div align="right" style="font-weight: bold; text-align: left;">Tarikh Selesai</div></td>
              <td valign="top"><div align="center" style="font-weight: bold">:</div></td>
              <td valign="top"><div align="left"><?php echo format_datetime($row_RsUrusan['TrKemaskini']); ?></div></td>
              </tr>
            <tr class="info"  >
              <td colspan="6"><div align="left" >
                <hr>
