...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
  <tr>
    ...
    <td width="100%" align="center" valign="top"><h3><img src="images/jatanegaramalaysia.png" width="92" height="75" /><br />
      Minit Mesyuarat di eCirculation JPA
<!--<div>-->
</h3>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
           ...
           <tr class="info"  >
            ...
            <tr>
              ...
              <td width="17%" valign="top"><div align="right" style="font-weight: bold; text-align: left;">Pengerusi</div></td>
              <td width="1%" valign="top"><div align="center" style="font-weight: bold">:</div></td>
              <td width="32%" valign="top"><div align="left">
			  <?php

			  if($row_RsUrusan['Status']=='Selesai'){
			  echo $row_RsUrusan['GelSelesai'];
			  echo $row_RsUrusan['NamaSelesai'];
			  }
			  else
			  {echo "  --";}
			  ?></div></td>
            ...
            <tr>
              ...
              <td valign="top"><div align="center" style="font-weight: bold">:</div></td>
			  <?php if($row_RsUrusan['TrSelesaiU']=="0000-00-00 00:00:00"){
			  $tarikhSelesai ="";
			  }else
			 
			 if($row_RsUrusan['TrSelesaiU']<>"0000-00-00 00:00:00")
			 {
			  $tarikhSelesai =format_date($row_RsUrusan['TrSelesaiU'],"%d/%m/%Y"); 
			 } 
			  
			   ?> 
              <td valign="top"><div align="left"><?php echo $tarikhSelesai; ?></div></td>
              </tr>
            <tr class="info"  >
              <td colspan="6"><div align="left" >
                <hr>
